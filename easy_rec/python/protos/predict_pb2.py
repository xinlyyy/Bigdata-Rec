...
from easy_rec.python.protos import tf_predict_pb2 as easy__rec_dot_python_dot_protos_dot_tf__predict__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[easy__rec_dot_python_dot_protos_dot_tf__predict__pb2.DESCRIPTOR,])
...
_PBRESPONSE_TFOUTPUTSENTRY.fields_by_name['value'].message_type = easy__rec_dot_python_dot_protos_dot_tf__predict__pb2._ARRAYPROTO
